...
export default function OrderTechnicalSpecification({
  ...
  return (
    <>
      ...
      {isOpen ? (
        <div className="fixed inset-0 z-[90] flex items-start justify-center overflow-auto bg-[#020b19]/70 px-4 py-6 backdrop-blur-[2px]">
          <div className="w-full max-w-5xl rounded-3xl border border-white/15 bg-[linear-gradient(180deg,#0d1f43_0%,#07132a_100%)] p-5 shadow-[0_30px_90px_rgba(2,8,24,0.6)] sm:p-6">
            <div className="flex flex-wrap items-start justify-between gap-3 border-b border-white/12 pb-4">
              <div>
                ...
                <h2 className="mt-1 text-2xl font-semibold tracking-tight text-white">Order {orderCode}</h2>
                {specData ? (
